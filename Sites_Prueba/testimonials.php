...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html"><span>Splinter </span>S.A.</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">Herramientas</a>
            <ul>
              <li><a href="about.html">Crea tu itinerario</a></li>
              <li><a href="team.html">Realizar Reserva</a></li>
          ...
          <li><a href="portfolio.html">Hoteles</a></li>
          <li><a href="pricing.html">Obras</a></li>
          <li><a href="blog.html">Lugares</a></li>
