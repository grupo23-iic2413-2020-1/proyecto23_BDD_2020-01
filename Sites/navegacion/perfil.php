                    ...
                    <table class="table table-bordered table-hover bg-white" style="align-self:center;width:90%;margin: 0 auto;">
                        ...
                        <?php
                            ...
                            <form align='center' action='perfil.php'  method='post'>
                                ...
                                <input class='btn btn-danger' align='center' type='submit' value='Devolver' name='devolver_ticket' style='font-size: 12px'>
                            </form>
                            </td></tr>";
                        }
                        ?>
                            ...
                            <?php
                                ...
                                echo "<tr> <td>$entr[0]</td> <td>$entr[1]</td> <td>$entr[2]</td> <td>$entr[3]</td>
                                    ...
                                    <form align='center' action='perfil.php'  method='post'>
                                        ...
                                        <input class='btn btn-danger' align='center' type='submit' value='Devolver' name='devolver_entrada' style='font-size: 12px'>
                                    </form>
                                    </td></tr>";
                            }
                            ?>
                            ...
                            <?php
                                ...
                                echo "<tr> <td>$res[0]</td> <td>$res[1]</td> <td>$res[2]</td> <td>$res[3]<</td>
                                    ...
                                    <form align='center' action='perfil.php'  method='post'>
                                        ...
                                        <input class='btn btn-danger' align='center' type='submit' value='Cancelar' name='cancelar_reserva' style='font-size: 12px'>
                                    </form>
                                    </td></tr>";
                            }
                            ?>
