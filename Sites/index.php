    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <div class="card bg-secondary">
          ...
          <a role="button" href="<?php echo $_SESSION["base_url"] ?>/navegacion/itinerario.php" class="btn btn-success">Ir</a>
        </div>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <div class="card bg-secondary">
          ...
          <a role="button" href="<?php echo $_SESSION["base_url"] ?>/navegacion/artistas.php" class="btn btn-success">Ir</a>
        </div>
      </div>
    </div>
  </div>
